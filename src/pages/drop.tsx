...
const Index = () => {
  ...
  return (
    <div className="w-full flex flex-col px-12 py-28 items-center">
        ...
        <div className="text-base cursor-pointer font-medium flex flex-row items-center" onClick={() => navigate('/collection')}>View All <Icon icon={icons.more_right} className="ml-1 h-5 w-5" /></div>
    </div>
  )
}
